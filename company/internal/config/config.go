...
type Postgres struct {
	...
	Database string `env:"POSTGRES_DB" env-default:"company"`
}

type App struct {
	Name     string `env:"APP_NAME" env-default:"company-service"`
	LogLevel string `env:"APP_LOG_LEVEL" env-default:"debug"`
}

type Keycloak struct {
	Realm        string `env:"KEYCLOAK_REALM" env-default:"app"`
	URL          string `env:"KEYCLOAK_URL" env-default:"http://booksvc-keycloak.booksvc.svc.cluster.local"`
